...
import pytest
from cgeom.structures import Circle, CrossSections, Rectangle, Ellipse, RectEllipse, Racetrack, Octagon, Polygon, ShapeTypes, Profile
...
def test_smoke_small_num_points(build_polygon_for_profile, profile):
    n = 8
