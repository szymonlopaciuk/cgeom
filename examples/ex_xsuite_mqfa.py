...
mqxfa_sigmas, tw, interpolated_points, envelope_at_max_sigma = aperture_model.get_aperture_sigmas_at_element(
    line_name="b1",
...
plt.plot(tw.s, mqxfa_sigmas, label='mqxfa num sigmas')
